						...
						<div class="span12">
							...
							<div class="row-fluid"  style="text-align: center;">
								<div class="span12 quan_header">
									...
									<div class="quan_search_partone">找到关于"${fn:substring(cname,0,8) }..."的${num }项商品。</div>
									<div class="quan_search_parttow">不满意？<a href="search.html" style="color:red;">再次搜索</a></div>
								</div>
